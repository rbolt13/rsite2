...
3 | output_dir: "docs" , will be discussed later, but is the name of the folder where the html files will live. 
...
### 5. Create home page, by creating a new rmarkdown and saving it to index.rmd. 
